...
namespace CrackMe {
	...
	// Define a key seed
	char* seed = "ehpf0(_hp0_pu(_4_tn4W_tsuJ_)|n@_3f1L_3hT_n1_3v0L_ruoY_t$oL_ohW_3lpoeP_r0hp_$1_gninwP";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelKey->Location = System::Drawing::Point(13, 14);
			this->labelKey->Name = L"labelKey";
			this->labelKey->Size = System::Drawing::Size(73, 13);
			this->labelKey->TabIndex = 0;
			this->labelKey->Text = L"Serial Number";
			this->labelKey->Click += gcnew System::EventHandler(this, &MainForm::labelKey_Click);
			// 
			// textBoxKey
			// 
			...
			this->textBoxKey->Size = System::Drawing::Size(504, 20);
			...
			this->panelLogo->Size = System::Drawing::Size(608, 100);
			this->panelLogo->TabIndex = 2;
			// 
			// buttonActivate
			// 
			this->buttonActivate->Anchor = System::Windows::Forms::AnchorStyles::None;
			this->buttonActivate->Location = System::Drawing::Point(63, 11);
			...
			this->buttonAbout->Location = System::Drawing::Point(265, 11);
			...
			this->buttonExit->Location = System::Drawing::Point(468, 11);
			...
			this->panelOrg->Size = System::Drawing::Size(608, 37);
			...
			this->labelOrg->Size = System::Drawing::Size(604, 33);
			this->labelOrg->TabIndex = 0;
			this->labelOrg->Text = L"SECOMPwn23";
			this->labelOrg->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			this->labelOrg->Click += gcnew System::EventHandler(this, &MainForm::labelOrg_Click);
			// 
			...
			this->tableLayoutPanelButtons->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent,
				33.33333F)));
			this->tableLayoutPanelButtons->Size = System::Drawing::Size(608, 46);
			...
			this->tableLayoutPanel1->Size = System::Drawing::Size(608, 41);
			...
			this->ClientSize = System::Drawing::Size(608, 224);
...
private: System::Void buttonActivate_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (strcmp(input_key, key)) {
		...
		MessageBox::Show("Pwned SECOMP23!", "Activation Successful", MessageBoxButtons::OK, MessageBoxIcon::Information);
	}

}
private: System::Void labelKey_Click(System::Object^ sender, System::EventArgs^ e) {
}
private: System::Void labelOrg_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}
